...
var GHOST_5_CANVAS_CONTEXT = null;
var GHOST_5_POSITION_X = 314;
var GHOST_5_POSITION_Y = 258;
var GHOST_5_DIRECTION = 2;
var GHOST_5_COLOR = "#04A777";
var GHOST_5_MOVING_TIMER = -1;
var GHOST_5_MOVING = false;
var GHOST_5_BODY_STATE = 4;
var GHOST_5_STATE = 0;
var GHOST_5_EAT_TIMER = null;
var GHOST_5_AFFRAID_TIMER = null;
var GHOST_5_AFFRAID_STATE = 0;
var GHOST_5_TUNNEL = false;

var GHOST_6_CANVAS_CONTEXT = null;
var GHOST_6_POSITION_X = 314;
var GHOST_6_POSITION_Y = 258;
var GHOST_6_DIRECTION = 2;
var GHOST_6_COLOR = "#820263";
var GHOST_6_MOVING_TIMER = -1;
var GHOST_6_MOVING = false;
var GHOST_6_BODY_STATE = 3;
var GHOST_6_STATE = 0;
var GHOST_6_EAT_TIMER = null;
var GHOST_6_AFFRAID_TIMER = null;
var GHOST_6_AFFRAID_STATE = 0;
var GHOST_6_TUNNEL = false;

var GHOST_7_CANVAS_CONTEXT = null;
var GHOST_7_POSITION_X = 314;
var GHOST_7_POSITION_Y = 258;
var GHOST_7_DIRECTION = 2;
var GHOST_7_COLOR = "#E7EFC5";
var GHOST_7_MOVING_TIMER = -1;
var GHOST_7_MOVING = false;
var GHOST_7_BODY_STATE = 2;
var GHOST_7_STATE = 0;
var GHOST_7_EAT_TIMER = null;
var GHOST_7_AFFRAID_TIMER = null;
var GHOST_7_AFFRAID_STATE = 0;
var GHOST_7_TUNNEL = false;

var GHOST_8_CANVAS_CONTEXT = null;
var GHOST_8_POSITION_X = 314;
var GHOST_8_POSITION_Y = 258;
var GHOST_8_DIRECTION = 2;
var GHOST_8_COLOR = "#FF3CC7";
var GHOST_8_MOVING_TIMER = -1;
var GHOST_8_MOVING = false;
var GHOST_8_BODY_STATE = 1;
var GHOST_8_STATE = 0;
var GHOST_8_EAT_TIMER = null;
var GHOST_8_AFFRAID_TIMER = null;
var GHOST_8_AFFRAID_STATE = 0;
var GHOST_8_TUNNEL = false;
...
function initGhosts() {
  if (LEVEL === 1) GHOST_LIST = ["blinky"];
  if (LEVEL >= 2) GHOST_LIST = ["blinky", "pinky", "inky", "clyde"];
  if (LEVEL >= 4) GHOST_LIST = ["blinky", "pinky", "inky", "clyde", "5", "6"];
  if (LEVEL >= 6)
    GHOST_LIST = ["blinky", "pinky", "inky", "clyde", "5", "6", "7", "8"];
  if (LEVEL >= 1) GHOST_MOVING_SPEED = 45;
  if (LEVEL >= 3) GHOST_MOVING_SPEED = 30;
  if (LEVEL >= 7) GHOST_MOVING_SPEED = 15;
  for (let g of GHOST_LIST) initGhost(g);
}
...
function resetGhosts() {
  ...
  GHOST_5_POSITION_X = 314;
  GHOST_5_POSITION_Y = 258;
  GHOST_5_DIRECTION = 4;
  GHOST_5_MOVING_TIMER = -1;
  GHOST_5_MOVING = false;
  GHOST_5_BODY_STATE = 3;
  GHOST_5_STATE = 0;
  GHOST_5_EAT_TIMER = null;
  GHOST_5_AFFRAID_TIMER = null;
  GHOST_5_AFFRAID_STATE = 0;

  GHOST_6_POSITION_X = 314;
  GHOST_6_POSITION_Y = 258;
  GHOST_6_DIRECTION = 4;
  GHOST_6_MOVING_TIMER = -1;
  GHOST_6_MOVING = false;
  GHOST_6_BODY_STATE = 3;
  GHOST_6_STATE = 0;
  GHOST_6_EAT_TIMER = null;
  GHOST_6_AFFRAID_TIMER = null;
  GHOST_6_AFFRAID_STATE = 0;

  GHOST_7_POSITION_X = 314;
  GHOST_7_POSITION_Y = 258;
  GHOST_7_DIRECTION = 4;
  GHOST_7_MOVING_TIMER = -1;
  GHOST_7_MOVING = false;
  GHOST_7_BODY_STATE = 3;
  GHOST_7_STATE = 0;
  GHOST_7_EAT_TIMER = null;
  GHOST_7_AFFRAID_TIMER = null;
  GHOST_7_AFFRAID_STATE = 0;

  GHOST_8_POSITION_X = 314;
  GHOST_8_POSITION_Y = 258;
  GHOST_8_DIRECTION = 4;
  GHOST_8_MOVING_TIMER = -1;
  GHOST_8_MOVING = false;
  GHOST_8_BODY_STATE = 3;
  GHOST_8_STATE = 0;
  GHOST_8_EAT_TIMER = null;
  GHOST_8_AFFRAID_TIMER = null;
  GHOST_8_AFFRAID_STATE = 0;
}
...
function drawGhosts() {
  for (let g of GHOST_LIST) drawGhost(g);
}
...
function affraidGhosts() {
  ...
  for (let g of GHOST_LIST) affraidGhost(g);
}
...
function moveGhosts() {
  for (let g of GHOST_LIST) moveGhost(g);
}
...
function eraseGhosts() {
  for (let g of GHOST_LIST) eraseGhost(g);
}
...
function stopGhosts() {
  for (let g of GHOST_LIST) stopGhost(g);
}
...
function pauseGhosts() {
  for (let g of GHOST_LIST) pauseGhost(g);
}
...
function resumeGhosts() {
  for (let g of GHOST_LIST) resumeGhost(g);
}
